...
namespace yan.libvlc
{
    ...
    public class MediaPlayerPool : MonoBehaviour
    {
        ...
        // 对象池自动清理时间间隔（秒）
        private const float AUTO_CLEANUP_INTERVAL = 60f;
        ...
        private void LogInfo(string message)
        {
            ...
            {
                Debug.Log($"[MediaPlayerPool] {message}");
            }
        }
        ...
        {
            Debug.LogWarning($"[MediaPlayerPool] {message}");
        }
        ...
        {
            Debug.LogError($"[MediaPlayerPool] {message}");
        }
